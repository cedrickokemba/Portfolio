...
<div class="card">
  ...
  <form method="post">
    <div class="field">
      ...
      <input placeholder="Nom d'utilisateur" class="input-field" name="username" type="username" required />
    </div>
    <div class="field">
    ...
    <button class="btn" type="button" onclick="window.location.href='authentification.php'">Connectez-vous ici</button>
    <button class="btn" type="button" onclick="window.location.href='../index.php'">Acceuil</button>
  </form>
</div>
<?php } ?>
</body>
